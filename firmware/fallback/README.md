...
| `qmk_rgb_streaming_697cf7c.bin` | Local build from `ryodeushii/qmk-firmware` fork | [`697cf7c`](https://github.com/ryodeushii/qmk-firmware/commit/697cf7c) | Our custom QMK + VIA + RGB streaming handler |
