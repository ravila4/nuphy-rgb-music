...
| `qmk_rgb_streaming_a62d78d.bin` | Local build from `ravila4/qmk-firmware` fork | [`a62d78d`](https://github.com/ravila4/qmk-firmware/commit/a62d78d) | QMK + VIA + per-key & side LED streaming. **Use this for this project** |
